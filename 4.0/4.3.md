...
- Corelate with other events 

# Dump files
- Store all contents of memory into a diagonistic file
...
- Many different way to gather this metric 
...
# Netflow
- Gather traffic statisitcs from all trafic flows 
...
# Protocol analyzer
- Solve complex apllication issues 
