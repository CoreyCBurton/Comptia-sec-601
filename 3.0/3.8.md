...
# Security Assertion Markip Language (SAML)
- Open standard for authentication and authorization 

- You can authenticate through a third-party to gain access 

- Not orginially designed for mobile apps 
...
- Not an authentication protocol 
  - Allows what anohter app can do
...
- Used in most operating systems 
  - A familar access control model 
...
- Access is deterined through system-enforced rules 
