...
- The process of making a host or app configuration secure by reducing its attack surface, through running only necessary services
  ...
  - Establishing a maintenance schedule to ensure the system is patches to be secure

# Open port and services
- Open port allws client sofrware to connect to application over a network
...
- Encrpyt everything on the drive 
...
- A specification for hardware-based storage of digital cerificates, kets, hashed passwords, abd other user and platform identification
